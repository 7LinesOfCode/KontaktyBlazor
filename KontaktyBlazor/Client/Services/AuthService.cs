...
namespace KontaktyBlazor.Client.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            var result = await _httpClient.PostAsJsonAsync("/Post/Register", registerModel);
        ...
        public async Task<LoginResult> Login(LoginModel loginModel)
        {
            ...
            var response = await _httpClient.PostAsync("/Post/Login", new StringContent(loginAsJson, Encoding.UTF8, "application/json"));
